...
@onready var fragments: Array[Sprite2D] = [
	...
	$"../FragmentsContainer/Fragment5", 
	$"../FragmentsContainer/Fragment6", 
	$"../FragmentsContainer/Fragment7", 
	$"../FragmentsContainer/Fragment8", 
	$"../FragmentsContainer/Fragment9", 
	$"../FragmentsContainer/Fragment10", 
	$"../FragmentsContainer/Fragment11", 
	$"../FragmentsContainer/Fragment12"
]

@onready var completion_label: Label = $"../CompletionLabel"
@export var objective_id: String = "aligning_pictures"
...
func _process(delta):
	if not puzzle_solved and is_puzzle_complete():
		...
		QuestManager.complete_objective("aligning_the_picture", str(objective_id))
		...
		if workbench_root:
			...
			get_tree().change_scene_to_file("res://scenes/Chapter3/Straight/Scene2/Dopplegangerhall/Chapter3Scene2Dopplegangerhall.tscn")
