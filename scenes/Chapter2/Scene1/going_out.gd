...
@export var target_scene_path: String = "res://scenes/Chapter2/Scene2/Chapter2Scene2BranchA.tscn"
...
func _on_body_entered(body: Node3D) -> void:
	...
	if save_manager.is_quest_completed(required_quest_id):
		...
		print("🚫 Quest not completed:", required_quest_id)
