...
# CC0 License
# Intended for rapid prototyping of first-person ga .
# Happy prototyping!

extends CharacterBody3D

@onready var animated_sprite_3d: AnimatedSprite3D = $Head/AnimatedSprite3D
...
# Determine if the character is moving
	...
	# Optional: Handle sprite flipping for left/right movement
	# Remove this if your sprites already face the correct direction
	if abs(velocity.x) > abs(velocity.z) and abs(velocity.x) > 0.1:
